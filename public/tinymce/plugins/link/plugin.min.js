!(function () {
			...
			((e) => {
				...
				return null === e
					...
					: "object" === t && Array.isArray(e)
						? "array"
						: "object" === t && ((n = o = e), (r = String).prototype.isPrototypeOf(n) || o.constructor?.name === r.name)
							? "string"
							: t;
				var n, o, r;
			})(t) === e,
	...
	const U = (e) => i(e) && "a" === e.nodeName.toLowerCase(),
		...
		V = (e) => /^\w+:/i.test(e),
		$ = (e) => e.getAttribute("data-mce-href") ?? e.getAttribute("href") ?? "",
		z = (e, t) => {
			const n = ["noopener"],
				o = e ? e.split(/\s+/) : [],
		...
		he = (e, t) => {
			...
			return {
				onChange: (e, t) => {
					...
					return "url" === r
						? ((e) => {
								const t = ((o = e.url), w(n.text.length <= 0, m.from(o.meta?.text).getOr(o.value)));
								var o;
								const r = ((e) => w(n.title.length <= 0, m.from(e.meta?.title).getOr("")))(e.url);
								return t.isSome() || r.isSome()
									? m.some({ ...t.map((e) => ({ text: e })).getOr({}), ...r.map((e) => ({ title: e })).getOr({}) })
									: m.none();
							})(e())
		...
		((e) => {
			...
			((e) => {
				e.addCommand("mceLink", (t, n) => {
					!0 !== n?.dialog && D(e) ? e.dispatch("contexttoolbar-show", { toolbarKey: "quicklink" }) : Oe(e);
				});
			})(e),
			Be(e),
			((e) => {
