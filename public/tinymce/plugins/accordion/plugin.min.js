!(function () {
			...
			((e) => {
				...
				return null === e
					...
					: "object" === t && Array.isArray(e)
						? "array"
						: "object" === t && ((o = r = e), (n = String).prototype.isPrototypeOf(o) || r.constructor?.name === n.name)
							? "string"
							: t;
				var o, r, n;
			})(e),
	...
	const u = Array.prototype.indexOf,
		...
		h = (e, t) => {
			for (let o = 0, r = e.length; o < r; o++) t(e[o], o);
		},
		f = Object.keys;
	let y = 0;
	...
	const b = (e, t) => ({ element: e, offset: t }),
		...
		_ = (e) => {
			...
			return ((e) => {
				...
				var o;
			})(T.fromDom(t)).fold(() => o.body.contains(t), ((r = _), (n = $), (e) => r(n(e))));
			var r, n;
		},
	...
	const te = (e, t, o) =>
		...
		re = (e, t) => {
			...
			const r = e.property().children(o);
			return r.length > 0 ? re(e, r[r.length - 1]) : b(o, oe(e, o));
		},
		ne = re,
		se = {
			up: c({
				selector: W,
				closest: (e, t, o) =>
					((e, t, o, r, n) => (((e, t) => A(e, t))(o, r) ? m.some(o) : a(n) && n(o) ? m.none() : t(o, r, n)))(
						0,
						W,
						e,
						t,
			...
			styles: c({
				get: (e, t) => {
					...
					return "" !== r || _(e) ? r : G(o, t);
				},
				getRaw: (e, t) => {
					const o = e.dom,
						r = G(o, t);
					return m.from(r).filter((e) => e.length > 0);
				},
				set: (e, t, r) => {
					((e, t, r) => {
						if (!o(r))
	...
	const ue = (e) => "SUMMARY" === e?.nodeName,
		ge = (e) => "DETAILS" === e?.nodeName,
		...
		Ne = (e) => {
			...
			const t = T.fromDom(e.getBody()),
				...
				n = e.dom.encode(e.translate("Accordion body...")),
				s = `<summary class="${ce}">${r}</summary>`,
				a = `<${le} class="${de}"><p>${n}</p></${le}>`;
						...
						K(t, "data-mce-id"),
							X(t, "summary").each((t) => {
								const o = e.dom.createRng(),
									r = ne(se, t);
								o.setStart(r.element.dom, r.offset), o.setEnd(r.element.dom, r.offset), e.selection.setRng(o);
							});
					});
			});
		},
	...
	const Se = (e) => {
			xe(e, "open") && De(e, "open", "open");
		},
		xe = (e, t) => void 0 !== e.attr(t),
		De = (e, t, o) => {
			e.attr(t, o);
		},
		Ee = (e) => e.attr("class")?.split(" ") ?? [],
		Oe = (e, t) => {
			const o = new Set([...Ee(e), ...t]),
				r = Array.from(o);
			r.length > 0 && e.attr("class", r.join(" "));
		},
		Me = (e, t) => {
			const o = ((e) => {
				const o = [];
		...
		Re = (e) => {
			...
			for (let e = 0; e < t.length; e++) {
				const i = t[e];
				"summary" === i.name && n(o) ? (o = i) : (a = i).name === le && g(Ee(a), de) && n(r) ? (r = i) : s.push(i);
			}
			var a;
			return { summaryNode: o, wrapperNode: r, otherNodes: s };
		},
		ke = (e) => {
			const t = new Ce("br", 1);
	...
	const Le = (e) => {
		((e) => {
			e.on("keydown", (t) => {
				((!t.shiftKey && t.keyCode === Be.ENTER && he(e)) ||
					((e) => {
	...
	e.add("accordion", (e) => {
		((e) => {
			...
			e.ui.registry.addButton("accordion", {
				...
				e.ui.registry.addMenuItem("accordion", { icon: "accordion", text: "Accordion", onSetup: Ve(e), onAction: t }),
				...
				e.on("PreInit", () => {
					...
					o.addNodeFilter(ae, (e) => {
						for (let t = 0; t < e.length; t++) {
							...
							if ((Se(o), Pe(o))) {
								const e = o,
									{ summaryNode: t, wrapperNode: r, otherNodes: a } = Re(e),
									i = s(t),
									c = i ? t : new Ce("summary", 1);
								n(c.firstChild) && ke(c),
									Oe(c, [ce]),
									i || (s(e.firstChild) ? e.insert(c, e.firstChild, !0) : e.append(c));
								const d = s(r),
									l = d ? r : new Ce(le, 1);
								if ((l.attr("data-mce-bogus", "1"), Oe(l, [de]), a.length > 0))
						...
						t.addNodeFilter(ae, (e) => {
							...
							for (let o = 0; o < e.length; o++) {
								...
								if (Pe(r)) {
									const e = r,
										{ summaryNode: o, wrapperNode: n } = Re(e);
									s(o) && Me(o, t), s(n) && n.unwrap();
								}
							}
						});
				});
