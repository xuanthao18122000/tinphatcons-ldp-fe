		...
		((e) => {
			...
			return null === e
				...
				: "object" === t && Array.isArray(e)
					? "array"
					: "object" === t && ((n = a = e), (r = String).prototype.isPrototypeOf(n) || a.constructor?.name === r.name)
						? "string"
						: t;
			var n, a, r;
		})(e);
			...
			const o = (e) =>
				...
				u = (e, t) => {
					...
					((e, t, n) => {
						...
						(e) => {
							...
							return {
								name: t,
								html: o({ name: t, url: `https://www.tiny.cloud/docs/tinymce/${tinymce.majorVersion}/${e.slug}/` }),
							};
						},
					);
					var i, s;
				...
				p = (e) => {
					const n = ((e) => {
							const n = l(e.plugins),
								a = v(e),
								r = t(a) ? ["onboarding", "licensekeymanager"] : a.concat(["onboarding", "licensekeymanager"]);
